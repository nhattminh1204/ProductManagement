...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  String _paymentMethod = 'cash'; // cash, credit_card, bank_transfer
  ...
  void initState() {
    ...
    // Attempt to pre-fill name from somewhere if possible? Not stored in AuthProvider currently except in implicit token data maybe. 
    // Just leave blank or TODO.
  ...
  void _submit() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (success && mounted) {
        ...
        // Show success dialog or snackbar then navigate
        showDialog(
          context: context,
  ...
  Widget build(BuildContext context) {
    ...
    final shipping = subtotal > 500 ? 0.0 : 20.0; // Free shipping > $500 as example
