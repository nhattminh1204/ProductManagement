...
class UserProductListScreen extends StatefulWidget {
  ...
  const UserProductListScreen({super.key, this.initialCategory});
...
class _UserProductListScreenState extends State<UserProductListScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // 1. Filter active (optional, if backend doesn't do it)
    // displayProducts = displayProducts.where((p) => p.status == 'active').toList();
      ...
      body: CustomScrollView(
        slivers: [
          ...
          SliverAppBar(
            ...
            foregroundColor: Colors.white, // Sets back button and icon color
              ...
              : SliverPadding(
                  ...
                  sliver: SliverGrid(
                    gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                      crossAxisCount: 2,
                      childAspectRatio:
                          0.8, // Taller ratio means shorter card height relative to width? No, width / height. higher = shorter card.
                      crossAxisSpacing: 12,
                      mainAxisSpacing: 12,
                    ),
          ...
          SliverPadding(padding: EdgeInsets.only(bottom: 100)), // Spacer
        ],
      ),
